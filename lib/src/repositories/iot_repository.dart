...
class IoTRepositoryV2 {
  ...
  Future<HealthData> saveHealthData(HealthData healthData) async {
    try {
      ...
      final employeeHealthPath =
          '$_healthDataCollection/${healthData.employeeId}';
      final timestamp =
      ...
      await _firebaseRepository.saveDocument(
          employeeHealthPath, timestamp, {'fields': firebaseData});
  ...
  Future<List<HealthData>> getHealthDataByEmployee(String employeeId,
    ...
    try {
      ...
      final firebaseDocs =
          await _firebaseRepository.getCollection(employeeHealthPath);
  ...
  Future<LocationData?> getCurrentLocation(String employeeId) async {
    try {
      ...
      final locationData =
          _locationDataFromSimpleFormat(firebaseDoc, employeeId);
  ...
  Future<List<LocationData>> getLocationHistory(String employeeId,
    ...
    try {
      ...
      final firebaseDocs =
          await _firebaseRepository.getCollection(employeeHistoryPath);
      ...
      for (final doc in firebaseDocs) {
        try {
          final locationData =
              _locationHistoryFromSimpleFormat(doc, employeeId);
  ...
  Future<void> saveLocationHistory(
    ...
    try {
      ...
      final employeeHistoryPath =
          '$_locationHistoryCollection/${locationData.employeeId}';
      final timestamp =
      ...
      await _firebaseRepository.saveDocument(
          employeeHistoryPath, timestamp, {'fields': historyData});
  ...
  HealthData _healthDataFromSimpleFormat(
  ...
  LocationData _locationDataFromSimpleFormat(
      Map<String, dynamic> firebaseDoc, String employeeId) {
    final fields = firebaseDoc['fields'] as Map<String, dynamic>;
  ...
  LocationData _locationHistoryFromSimpleFormat(
      Map<String, dynamic> firebaseDoc, String employeeId) {
    final fields = firebaseDoc['fields'] as Map<String, dynamic>;
