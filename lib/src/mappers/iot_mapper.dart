...
class IoTMapper {
    ...
    return {
      'fields': {
        ...
        'processed_at': healthData.processedAt != null
            ? {
                'timestampValue':
                    healthData.processedAt!.toUtc().toIso8601String()
              }
            : null,
  ...
  static HealthData healthDataFromFirebase(Map<String, dynamic> firebaseDoc) {
    try {
      ...
      throw FormatException(
          'Erro ao converter documento Firebase para HealthData: $e');
    }
  }
  ...
  static Map<String, dynamic> locationDataToFirebase(
    ...
    return {
      'fields': {
        ...
        'processed_at': locationData.processedAt != null
            ? {
                'timestampValue':
                    locationData.processedAt!.toUtc().toIso8601String()
              }
            : null,
  ...
  static LocationData locationDataFromFirebase(
    ...
    try {
      ...
      throw FormatException(
          'Erro ao converter documento Firebase para LocationData: $e');
    }
  }
  ...
  static Map<String, dynamic> alertToFirebase(Map<String, dynamic> alert) {
    return {
      'fields': {
        ...
        'timestamp': {
          'timestampValue':
              alert['timestamp'] ?? DateTime.now().toUtc().toIso8601String()
        },
        'details': alert['details'] != null
            ? {'stringValue': alert['details'].toString()}
            : null,
        'zone': alert['zone'] != null ? {'stringValue': alert['zone']} : null,
  ...
  static Map<String, dynamic> alertFromFirebase(
      Map<String, dynamic> firebaseDoc) {
    try {
      final fields = firebaseDoc['fields'] as Map<String, dynamic>;
      ...
      throw FormatException(
          'Erro ao converter documento Firebase para Alert: $e');
    }
  }
