...
void main() async {
  print('🗃️ POPULANDO BANCO LOCAL - API V2.1.0 (CORRIGIDO)');
  print('=================================================');
  ...
  try {
    ...
    // 2. Criar funcionários base - SETORES CORRETOS
    print('\n👥 2. CRIANDO FUNCIONÁRIOS BASE...');
    final employees = [
      {
        'id': 'EMP001',
        'nome': 'João Silva',
        'setor': 'producao',  // ✅ SETOR VÁLIDO
      ...
      },
      {
        'id': 'EMP002', 
        'nome': 'Maria Santos',
        'setor': 'producao',  // ✅ MUDEI PARA PRODUCAO (setor válido)
      ...
      },
      {
        ...
        'setor': 'administrativo',  // ✅ SETOR VÁLIDO
    ...
    // 3. Adicionar dados de saúde - SEM TIMESTAMP (deixar automático)
    ...
    final healthData = [
      {
        ...
        // ✅ REMOVIDO timestamp - deixar automático
      },
      {
        'employee_id': 'EMP002', 
        'heart_rate': 72,
    ...
    // 4. Adicionar localizações - SEM TIMESTAMP (deixar automático)
    ...
    final locations = [
      ...
      {
        'employee_id': 'EMP002',
        'latitude': -3.7330,  // zona alternativa
        'longitude': -38.5280,
        'device_id': 'DEVICE_002'
      },
      {
...
// 🔧 PRIMEIRO, verificar quais setores são válidos:
// curl http://localhost:8080/api/employees
// Ver exemplo de funcionário existente para saber formato correto