...
class TemplateService {
  ...
  static const Map<String, EndpointInfo> _endpoints = {
    'GET /api/employees':
        EndpointInfo('GET', '/api/employees', 'Lista todos os funcionários'),
    'GET /api/employees/:id': EndpointInfo(
        'GET', '/api/employees/:id', 'Busca funcionário específico'),
    'POST /api/employees':
        EndpointInfo('POST', '/api/employees', 'Cria novo funcionário'),
    'PUT /api/employees/:id':
        EndpointInfo('PUT', '/api/employees/:id', 'Atualiza funcionário'),
    'DELETE /api/employees/:id':
        EndpointInfo('DELETE', '/api/employees/:id', 'Remove funcionário'),
  ...
  static Future<String> _renderEndpoint(EndpointInfo endpoint) async {
    try {
      final template =
          await _loadTemplate('templates/components/endpoint.html');
  ...
  static Future<String> _generateEndpointsHtml(
      List<String> endpointKeys) async {
    ...
    const example = '''
{
  ...
  static String _getFallbackDocumentation(
      String apiName, String version, String baseUrl) {
    return '''
<!DOCTYPE html>
<html>
